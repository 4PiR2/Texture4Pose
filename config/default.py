...
dataset = dict(
    ...
    max_dzi_ratio=0.,  # dynamic zoom in
    bbox_zoom_out_ratio=1,
    light_max_saturation=0.,
    light_ambient_range=(1., 1.),
    light_diffuse_range=(1., 1.),
    light_specular_range=(1., 1.),
    light_shininess_range=(10, 10),
    num_obj=None,
